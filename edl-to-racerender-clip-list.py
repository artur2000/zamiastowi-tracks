...
if __name__ == '__main__':
    ...
    if (len(timelineEvents) > 0):
        ...
        with open(targetFileName, 'w') as f:
            f.write("num;clip_name;src_start_tc;src_end_tc;rec_start_tc;rec_end_tc;racerender_offset;racerender_offset_end\n")
            for timelineEvent in timelineEvents:
                ...
                # we avoid having the "media offline" errors at the end of the clip in case of timecode calculation precision errors
                ...
                f.write(';'.join([timelineEvent.event_no, timelineEvent.clip_name, timelineEvent.src_start_tc,
                                  ...
                                  timelineEvent.rec_end_tc, str(recTcOffset), str(recTcOffsetEnd)]) + "\n")
            f.close()
    else:
